...
<?php ob_start();?>
                        ...
                        while($data=$reqComments->fetch()){
                            ...
                            <div class="row">
                                ...
                                if(!isset($_SESSION['id']) && !isset($_SESSION['login'])){ ?>
                                    ...
                                    ?>
                                    <p><a href="index.php?action=deleteComment&commentId=<?= $data['id'] ?>"><button class="btn btn-danger">Supprimer</button> </a>
                                    </p>
                                    <?php
                                }
                                ?>
    ...
    <div class="btn-group">
        ...
        for ($i=1;$i<=$number;$i++){
            ?>
            <a href="index.php?action=chapter&id=<?php echo $_GET['id']?>&page=<?php echo $i ?>"><button class="btn btn-primary "><?php echo $i ?></button> </a>
